 ...
 */
/*
function login_db_upgrade_1() {
}
function login_db_upgrade_2() {
}
*/

function icms_module_update_login($module) {
    return TRUE;
}

function icms_module_install_login($module) {
	return TRUE;
}